    ...
    <div class="row">
        <div class="card shadow mb-4" style="width: 100%">
            ...
            <div class="card-body" style="width: 10%">
                <form class="form-text" action="<c:url value="/users/add"/>" method="post">
                    <label>
                        User name
                        <input type="text" style="width: 1400%; margin-bottom: 10%; margin-top: 10%" class="form-control form-control-user" name="userName" placeholder="User name">
                    </label>
                    <label>
                        Email
                    ...
                    <button type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Save</button>
                </form>
            </div>
        </div>
    </div>
